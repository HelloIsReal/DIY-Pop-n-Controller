...
Looking at what I need to do next. I realised that I would need a part materials list.
Mainly in order to build the controller, but also to know what components I actually need to build this controller

I was also planning on using a case that was already perfect for this. But apparently I need to make the case myself too :sob:.
I'll have to learn how to use a 3d software in order to make a case :pray:
